    ...
    acf_add_local_field_group(array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'sub_fields' => array(
                    array(
                        ...
                        'button_label' => '項目を追加',
                        'sub_fields' => array(
                            lh_acf_text('field_lh_trust_item_label', 'ラベル', 'label'),
                            lh_acf_text('field_lh_trust_item_text', '本文', 'text'),
                        ),
                    ),
                ),
            ),
            array(
                ...
                'layout' => 'block',
                'sub_fields' => array(
                    lh_acf_text('field_lh_timing_en_label', '英字ラベル', 'en_label'),
                    lh_acf_text('field_lh_timing_title', 'タイトル', 'title'),
                    array(
                        'key' => 'field_lh_timing_items',
                        'label' => '項目',
                        'name' => 'items',
                        'type' => 'repeater',
                        'layout' => 'block',
                        'button_label' => '項目を追加',
                        'sub_fields' => array(
                            lh_acf_text('field_lh_timing_item_title', '見出し', 'title'),
                            lh_acf_textarea('field_lh_timing_item_body', '本文', 'body', 4),
                        ),
                    ),
                    array(
                        'key' => 'field_lh_timing_cta',
                        'label' => 'CTA',
                        'name' => 'cta',
                        'type' => 'group',
                        'layout' => 'table',
                        'sub_fields' => array(
                            lh_acf_text('field_lh_timing_cta_label', 'ラベル', 'label'),
                            lh_acf_text('field_lh_timing_cta_url', 'URL', 'url'),
                            array(
                                'key' => 'field_lh_timing_cta_style',
                                'label' => 'スタイル',
                                'name' => 'style',
                                'type' => 'select',
                                'choices' => array(
            ...
            array(
                'key' => 'field_lh_partner_support',
                'label' => '連携案内',
                'name' => 'lh_partner_support',
                'type' => 'group',
                'layout' => 'block',
                'sub_fields' => array(
                    lh_acf_text('field_lh_partner_support_headline_en', '英字見出し', 'headline_en'),
                    lh_acf_text('field_lh_partner_support_headline_ja', '和文見出し', 'headline_ja'),
                    lh_acf_textarea('field_lh_partner_support_intro', '導入文', 'intro', 6),
                    array(
                        'key' => 'field_lh_partner_support_cards',
                        'label' => 'カード',
                        'name' => 'cards',
                        'type' => 'repeater',
                        'layout' => 'block',
                        'button_label' => 'カードを追加',
                        'sub_fields' => array(
                            lh_acf_text('field_lh_partner_support_card_title', '見出し', 'title'),
                            lh_acf_textarea('field_lh_partner_support_card_body', '本文', 'body', 4),
                        ),
                    ),
                    lh_acf_text('field_lh_partner_support_cta_label', 'CTAラベル', 'cta_label'),
                    lh_acf_text('field_lh_partner_support_cta_url', 'CTA URL', 'cta_url'),
                    lh_acf_text('field_lh_partner_support_referrer_link_label', '補助リンク文言', 'referrer_link_label'),
                    lh_acf_text('field_lh_partner_support_referrer_link_url', '補助リンクURL', 'referrer_link_url'),
                ),
            ),
            array(
            ...
            array(
                'key' => 'field_lh_knowledge',
                'label' => 'Knowledge',
                'name' => 'lh_knowledge',
                'type' => 'group',
                'layout' => 'block',
                'sub_fields' => array(
                    lh_acf_text('field_lh_knowledge_en_label', '英字ラベル', 'en_label'),
                    lh_acf_text('field_lh_knowledge_title', 'タイトル', 'title'),
                    array(
                        'key' => 'field_lh_knowledge_items',
                        'label' => '記事カード',
                        'name' => 'items',
                        'type' => 'repeater',
                        'layout' => 'block',
                        'button_label' => '記事カードを追加',
                        'sub_fields' => array(
                            lh_acf_text('field_lh_knowledge_item_title', '見出し', 'title'),
                            lh_acf_textarea('field_lh_knowledge_item_body', '本文', 'body', 4),
                            lh_acf_text('field_lh_knowledge_item_url', 'URL', 'url'),
                            lh_acf_text('field_lh_knowledge_item_link_label', 'リンク文言', 'link_label'),
                        ),
                    ),
                ),
            ),
